...
function question5() {
  ...
  // 5.1. ['cat', 42, 'bird']
  console.log("5.1. Number of elements (3)", ["string", "num", "string"]);

  // 5.2. [[], 24, 'hello', true]
  console.log("5.2. Number of elements (4)", ["array", "num", "string", "boolean"]);

  // 5.3. []
  console.log("5.3. Number of elements (0)", []);

  // 5.4. [['romeo', 'juliet'], false]
  console.log("5.4. Number of elements (2)", ["array", "bool"]);

  // 5.5. [{name: 'bob', age: 23}, {name: 'paul', age: 33}]
  console.log("5.5. Number of elements (2)", ["objects", "objects"]);
}
